...
public class BeanAwareUseCasePublisher implements UseCasePublisher {
  ...
  public <R, T extends UseCase> R publish(Class<R> returnClass, T useCase) {
    var useCaseHandler
        = (UseCaseHandler<R, T>) UseCaseHandlerRegistry.INSTANCE.detectUseCaseHandlerFrom(
        useCase.getClass());
  ...
  public <R, T extends UseCase> void publish(T useCase) {
    var voidUseCaseHandler
        = (VoidUseCaseHandler<T>) UseCaseHandlerRegistry.INSTANCE.detectVoidUseCaseHandlerFrom(
        useCase.getClass());
  ...
  public <R> R publish(Class<R> returnClass) {
    var useCaseHandler
        = (NoUseCaseHandler<R>) UseCaseHandlerRegistry.INSTANCE.detectNoUseCaseHandlerFrom(
        returnClass);
  ...
  private <R, T extends UseCase> void validateUseCaseHandlerDetection(T useCase,
    ...
    if (Objects.isNull(useCaseHandler)) {
      ...
      throw new DecisionMakerBusinessException("decisionmaker.useCaseHandler.notDetected");
    }
  }

  private <T extends UseCase> void validateVoidUseCaseHandlerDetection(T useCase,
