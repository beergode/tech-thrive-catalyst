...
public class RestExceptionHandler extends BaseController {
    ...
    @ExceptionHandler(DecisionMakerBusinessException.class)
    @ResponseStatus(HttpStatus.UNPROCESSABLE_ENTITY)
    public Response<ErrorResponse> handlePaymentApiBusinessException(DecisionMakerBusinessException ex, Locale locale) {
